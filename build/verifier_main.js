...
const initializeAcmeVerifierAgent = () =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const agent = new core_1.Agent({
      ...
      modules: {
        ...
        openId4VcVerifier: new openid4vc_1.OpenId4VcVerifierModule({
          baseUrl: "https://trustinc.fly.dev/oid4vci/",
    ...
    agent.registerInboundTransport(
      new node_1.HttpInboundTransport({ port: 3002 })
    ); //avoid conflict with app
    yield agent.initialize();
    return agent;
  });
const createNewInvitation = (agent) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const createAuthorizationRequestAndSession = (
  acmeVerifierAgent,
  openId4VcVerifier
) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const verifierDidKey = core_1.DidKey.fromDid(
      verifierDidResult.didState.did
    );
    const { authorizationRequest, verificationSession } =
      yield acmeVerifierAgent.modules.openId4VcVerifier.createAuthorizationRequest(
        {
...
const run = () =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const openId4VcVerifier =
      yield acmeVerifierAgent.modules.openId4VcVerifier.createVerifier({});
    const { authorizationRequest, verificationSession } =
      yield createAuthorizationRequestAndSession(
        acmeVerifierAgent,
        openId4VcVerifier
      );
    console.log(
    ...
    acmeVerifierAgent.events.on(
      openid4vc_1.OpenId4VcVerifierEvents.VerificationSessionStateChanged,
      (event) =>
        __awaiter(void 0, void 0, void 0, function* () {
          ...
          if (
            ...
            const verifiedAuthorizationResponse =
              yield acmeVerifierAgent.modules.openId4VcVerifier.getVerifiedAuthorizationResponse(
