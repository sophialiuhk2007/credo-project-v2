...
const run = () => __awaiter(void 0, void 0, void 0, function* () {
  ...
  only in the verifier part*/
    ...
    const openid4vcIssuer = yield acmeAgent.modules.openId4VcIssuer.createIssuer({
        display: [
            {
                name: "ACME Corp.",
    ...
    const { credentialOffer, issuanceSession } = yield acmeAgent.modules.openId4VcIssuer.createCredentialOffer({
