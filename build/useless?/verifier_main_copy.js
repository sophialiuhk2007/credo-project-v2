...
const initializeAcmeVerifierAgent = () => __awaiter(void 0, void 0, void 0, function* () {
    const config = {
...
const setupConnectionListener = (agent, outOfBandRecord, cb) => {
    agent.events.on(core_1.ConnectionEventTypes.ConnectionStateChanged, (_a) => __awaiter(void 0, [_a], void 0, function* ({ payload }) {
...
const createAuthorizationRequestAndSession = (acmeVerifierAgent, openId4VcVerifier) => __awaiter(void 0, void 0, void 0, function* () {
    // Create a did:key that we will use for signing OpenID4VP authorization requests
    const verifierDidResult = yield acmeVerifierAgent.dids.create({
        method: "key",
        options: {
    ...
    const { authorizationRequest, verificationSession } = yield acmeVerifierAgent.modules.openId4VcVerifier.createAuthorizationRequest({
...
const run = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const acmeVerifierAgent = yield initializeAcmeVerifierAgent();
    console.log("Creating the invitation as Acme Verifier...");
    const { outOfBandRecord, invitationUrl } = yield createNewInvitation(acmeVerifierAgent);
    console.log(`Share this invitation with Bob: ${invitationUrl}`);
    const openId4VcVerifier = yield acmeVerifierAgent.modules.openId4VcVerifier.createVerifier({});
    const { authorizationRequest, verificationSession } = yield createAuthorizationRequestAndSession(acmeVerifierAgent, openId4VcVerifier);
    console.log("Created OpenID4VC authorization request", JSON.stringify(authorizationRequest, null, 2));
    setupConnectionListener(acmeVerifierAgent, outOfBandRecord, (connectionId) => __awaiter(void 0, void 0, void 0, function* () {
        yield acmeVerifierAgent.basicMessages.sendMessage(connectionId, "hello Bob, please accept this invitation and send me your credentials."
    ...
    //   }
    // );
    acmeVerifierAgent.events.on(openid4vc_1.OpenId4VcVerifierEvents.VerificationSessionStateChanged, (event) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (event.payload.verificationSession.state ===
            ...
            const verifiedAuthorizationResponse = yield acmeVerifierAgent.modules.openId4VcVerifier.getVerifiedAuthorizationResponse(verificationSession.id);
