...
const createOpenId4VcIssuer = (acmeAgent) => __awaiter(void 0, void 0, void 0, function* () {
    return yield acmeAgent.modules.openId4VcIssuer.createIssuer({
        display: [
            {
                name: "ACME Corp.",
...
const createIssuerDid = (acmeAgent) => __awaiter(void 0, void 0, void 0, function* () {
    const issuerDidResult = yield acmeAgent.dids.create({
        method: "key",
        options: {
...
const createCredentialOfferAndSession = (acmeAgent, openid4vcIssuer) => __awaiter(void 0, void 0, void 0, function* () {
    return yield acmeAgent.modules.openId4VcIssuer.createCredentialOffer({
...
const run = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const openid4vcIssuer = yield createOpenId4VcIssuer(acmeAgent);
    yield createIssuerDid(acmeAgent);
    const { credentialOffer, issuanceSession } = yield createCredentialOfferAndSession(acmeAgent, openid4vcIssuer);
