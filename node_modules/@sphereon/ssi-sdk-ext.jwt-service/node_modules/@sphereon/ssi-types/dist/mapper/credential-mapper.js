...
class CredentialMapper {
    ...
    static toWrappedVerifiablePresentation(originalPresentation, opts) {
        ...
        const vcs = noVCs
            ? []
            : CredentialMapper.toWrappedVerifiableCredentials((_a = vp.verifiableCredential) !== null && _a !== void 0 ? _a : [] /*.map(value => value.original)*/, opts);
    ...
    static storedCredentialToOriginalFormat(credential) {
        ...
        else if ('proof' in credential && credential.proof.type === types_1.IProofType.SdJwtProof2024 && credential.proof.jwt) {
            return credential.proof.jwt;
        }
