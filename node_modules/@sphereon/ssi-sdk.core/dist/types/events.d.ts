import { ActionSubType, ActionType, InitiatorType, LoggingEventType, LogLevel, SimpleLogEvent, SubSystem, System, SystemCorrelationIdType } from '@sphereon/ssi-types';
import { IAgentContext } from '@veramo/core';
export declare enum PartyCorrelationType {
    DID = "did",
    URL = "url",
    EMAIL = "email",
    HOSTNAME = "hostname",
