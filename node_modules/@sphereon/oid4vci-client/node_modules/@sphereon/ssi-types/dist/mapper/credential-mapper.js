...
class CredentialMapper {
    ...
    static toWrappedVerifiablePresentation(originalPresentation, opts) {
        ...
        if (CredentialMapper.isMsoMdocDecodedPresentation(originalPresentation) || CredentialMapper.isMsoMdocOid4VPEncoded(originalPresentation)) {
            ...
            const mdocCredential = (_a = deviceResponse.documents) === null || _a === void 0 ? void 0 : _a.map((doc) => CredentialMapper.toWrappedVerifiableCredential(doc, opts)).find((value) => value !== undefined);
            if (mdocCredential === undefined) {
                throw Error('mdoc credential data corruption');
            }
            return {
                type: CredentialMapper.isMsoMdocDecodedPresentation(originalPresentation) ? types_1.OriginalType.MSO_MDOC_DECODED : types_1.OriginalType.MSO_MDOC_ENCODED,
                format: 'mso_mdoc',
        ...
        const vcs = noVCs
            ? []
            : CredentialMapper.toWrappedVerifiableCredentials((_b = vp.verifiableCredential) !== null && _b !== void 0 ? _b : [] /*.map(value => value.original)*/, opts);
    ...
    static toWrappedVerifiableCredential(verifiableCredential, opts) {
        ...
        if (CredentialMapper.isMsoMdocDecodedCredential(verifiableCredential) || CredentialMapper.isMsoMdocDecodedCredential(verifiableCredential)) {
            ...
            return {
                ...
                credential: (0, types_1.mdocDecodedCredentialToUniformCredential)(mdoc),
                decoded: mdoc,
            };
        }
        // SD-JWT
    ...
    static toUniformCredential(verifiableCredential, opts) {
        ...
        const decoded = CredentialMapper.decodeVerifiableCredential(original, opts === null || opts === void 0 ? void 0 : opts.hasher);
        const isJwtEncoded = CredentialMapper.isJwtEncoded(original);
        const isJwtDecoded = CredentialMapper.isJwtDecodedCredential(original);
