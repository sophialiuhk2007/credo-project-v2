...
exports.MetadataClientV1_0_11 = void 0;
...
class MetadataClientV1_0_11 {
    ...
    static retrieveAllMetadata(issuer, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const oid4vciResponse = yield MetadataClientV1_0_11.retrieveOpenID4VCIServerMetadata(issuer, { errorOnNotFound: false }); // We will handle errors later, given we will also try other metadata locations
            ...
            let response = yield (0, OpenIDUtils_1.retrieveWellknown)(authorization_server, oid4vci_common_1.WellKnownEndpoints.OPENID_CONFIGURATION, {
            ...
            if (authMetadata) {
                ...
                // Now let's do OAuth2
                response = yield (0, OpenIDUtils_1.retrieveWellknown)(authorization_server, oid4vci_common_1.WellKnownEndpoints.OAUTH_AS, { errorOnNotFound: false });
...
exports.MetadataClientV1_0_11 = MetadataClientV1_0_11;
//# sourceMappingURL=MetadataClientV1_0_11.js.map