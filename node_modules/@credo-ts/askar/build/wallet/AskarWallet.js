...
let AskarWallet = class AskarWallet extends AskarBaseWallet_1.AskarBaseWallet {
        ...
        try {
            ...
            if (rekey) {
                await this._store.rekey({
                    passKey: rekey,
                    keyMethod: (0, utils_1.keyDerivationMethodToStoreKeyMethod)(rekeyDerivation ?? core_1.KeyDerivationMethod.Argon2IMod),
                });
            }
            // TODO: Should we do something to check if it exists?
            // Like this.withSession()?
    ...
    async export(exportConfig) {
        ...
        if ((0, AskarWalletStorageConfig_1.isAskarWalletSqliteStorageConfig)(this.walletConfig.storage) && this.walletConfig.storage?.inMemory) {
    ...
    async getAskarWalletConfig(walletConfig) {
        ...
        return {
            ...
            keyMethod: (0, utils_1.keyDerivationMethodToStoreKeyMethod)(walletConfig.keyDerivationMethod ?? core_1.KeyDerivationMethod.Argon2IMod),
