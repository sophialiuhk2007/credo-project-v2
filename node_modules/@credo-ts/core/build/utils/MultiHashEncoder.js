...
const hashes_1 = require("../crypto/hashes");
...
const multiHashCodeMap = Object.entries(multiHashNameMap).reduce((map, [hashName, hashCode]) => ({ ...map, [hashCode]: hashName }), {});
class MultiHashEncoder {
    ...
    static encode(data, hashName) {
        const hash = hashes_1.Hasher.hash(data, hashName);
