...
let RevocationNotificationService = class RevocationNotificationService {
    ...
    async v2ProcessRevocationNotification(messageContext) {
        ...
        try {
            const credentialIdGroups = credentialId.match(revocationIdentifier_1.v2IndyRevocationIdentifierRegex) ?? credentialId.match(revocationIdentifier_1.v2AnonCredsRevocationIdentifierRegex);
