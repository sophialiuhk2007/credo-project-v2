...
class Agent extends BaseAgent_1.BaseAgent {
    constructor(options, dependencyManager = new plugins_1.DependencyManager()) {
        ...
        if (!dependencyManager.isRegistered(constants_1.InjectionSymbols.Wallet)) {
            throw new error_1.CredoError("Missing required dependency: 'Wallet'. You can register it using the AskarModule, or implement your own.");
        }
    ...
    async initialize() {
        ...
        this.messageSubscription = this.eventEmitter
            ...
            .pipe((0, operators_1.takeUntil)(stop$), (0, operators_1.mergeMap)((e) => this.messageReceiver
    ...
    async getMediationConnection(mediatorInvitationUrl) {
        ...
        if (!connection) {
            ...
            if (!newConnection) {
                throw new error_1.CredoError('No connection record to provision mediation.');
            }
