...
exports.receiveInvitation = exports.createBobAgent = void 0;
...
const createBobAgent = () => {
    ...
    const agent = new core_1.Agent({
        ...
        modules: {
            ...
            basicMessagesModule: new core_1.BasicMessagesModule(), // <-- THIS LINE IS REQUIRED
        },
    });
...
exports.createBobAgent = createBobAgent;
