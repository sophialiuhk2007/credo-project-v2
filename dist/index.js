...
const web_server_1 = require("./web_server");
    ...
    try {
        ...
        while (retries > 0 && agent === null) {
            try {
                ...
                console.error(`Agent initialization error (retries left: ${retries - 1}):`, agentError);
                retries--;
                if (retries > 0) {
        ...
        const server = await (0, web_server_1.startServer)();
